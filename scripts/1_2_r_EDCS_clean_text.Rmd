...
```{r, loading data}
resp = request("EDCS_merged_2020-12-09.json", path="/sharingin/648597@au.dk/SDAM_root/SDAM_data/EDCS", method="GET", cred=mycred_secret)
```
...
resp = request("EDCS_merged_2020-12-09.json", path="/sharingin/648597@au.dk/SDAM_root/SDAM_data/EDCS", method="GET")
```
...
mycred_secret<- readLines("~/mysecret.txt")
write(EDCS_cleaned_json, file="output/EDCS_text_cleaned_2020-12-29.json")
request("output/EDCS_text_cleaned_2020-12-29.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/EDCS/",
