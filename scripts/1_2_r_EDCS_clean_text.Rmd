...
mycred_secret<- readLines("~/mysecret.txt")
write(EDCS_cleaned_json, file="output/EDCS_text_cleaned_2021-01-20.json")
request("output/EDCS_text_cleaned_2021-01-20.json", path="/sharingout/648597@au.dk/SDAM_root/SDAM_data/EDCS/public",
