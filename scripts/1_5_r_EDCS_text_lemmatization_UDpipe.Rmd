---
title: "Text lemmatization of EDCS with UDpipe"
author:
...
# Save JSON locally 
(serialize as below, if it's too big and RStudio keeps crashing)
```{r, Perseus model}
...
# only if you have access to Sciencedata, otherwise create a local version
